from constants import UNIDADES, DEZENAS, TEENS
...
class Cents:
    ...
    def cents_extense(self):
        if self.first_number == 00:
            ...
            return f"e {DEZENAS[self.first_number]} {self.sufix}"
        else:  # XXXX.{VAR}{VAR}
            return f"e {DEZENAS[self.first_number]} e {UNIDADES[self.second_number]} {self.sufix}"
